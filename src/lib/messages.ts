export const messages = {
  ...
  dashboard: {
    ...
    benchmarkTitle: "クリニック間ベンチマーク",
    benchmarkSatisfaction: "患者満足度（直近3ヶ月）",
    benchmarkMonthlyCount: "今月の回答数",
    benchmarkYourClinic: "あなたの医院",
    benchmarkPlatformAvg: "全体平均",
    benchmarkTopPercent: "上位",
    benchmarkNotEnoughData: "比較対象のクリニックが増えると表示されます",
    benchmarkClinicsCompared: "クリニック比較",
