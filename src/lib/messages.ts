export const messages = {
  ...
  landing: {
    ...
    heroSub:
      "30秒のタブレットアンケートで患者の本音を数値化。\n質問別スコア・トレンド分析・改善提案まで、\nデータに基づく患者体験の改善サイクルを実現します。",
    heroCta: "無料で始める",
    heroCtaSub: "機能を詳しく見る",
    heroBadge: "医療機関専用 患者満足度向上プラットフォーム",
    ...
    pain2Title: "改善の効果が測れない",
    pain2Desc:
      "接遇研修やオペレーション改善を行っても、患者満足度への影響を数値で確認する手段がない。",
    pain3Title: "データ集計に手間がかかる",
    pain3Desc:
      "紙アンケートの配布・回収・集計に時間を取られ、分析まで手が回らない。",

    // Solution overview
    solutionTitle: "患者体験を数値化し、改善サイクルを回す",
    solutionDesc:
      "MIERU Clinicは、タブレットアンケートで患者満足度を定量化し、質問別スコアで改善ポイントを特定。スタッフの配布習慣をゲーミフィケーションで支える ── 医療機関専用の患者満足度向上プラットフォームです。",
    ...
    result3Value: "リアルタイム",
    result3Label: "データ反映速度",
    result3Desc: "回答直後にダッシュボードへ反映",
