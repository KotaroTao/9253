export const messages = {
  ...
  landing: {
    ...
    pain2Desc:
      "紙アンケートの配布・回収・集計に時間を取られ、分析まで手が回らない。非効率な作業に忙殺され、改善のサイクルが始まらない。",
    ...
    solutionDesc:
      "MIERU Clinicは、タブレットアンケートで患者満足度を定量化し、集計・分析を自動化。スタッフの配布習慣をゲーミフィケーションで支え、月次レポートで満足度と経営指標の相関を可視化する ── 歯科医院専用の患者体験改善プラットフォームです。",
    solutionValue1Title: "可視化する",
    solutionValue1Desc:
      "患者満足度をスコアで定量化。質問別分析・トレンド把握を自動化し、改善ポイントを即座に特定",
    solutionValue2Title: "習慣化する",
    solutionValue2Desc:
      "日次目標・ランクシステム・Kawaii Teethコレクションなどのゲーミフィケーションで、アンケート配布をスタッフの日常業務に定着",
    solutionValue3Title: "経営に接続する",
    solutionValue3Desc:
      "来院数と売上を入力するだけでKPIを自動算出。満足度と経営指標の相関を可視化し、改善施策の効果を数字で検証",

    // Features
    featuresTitle: "集計・分析・改善を自動化する、ワンストップ機能",
    featuresSub: "",
    feature1Title: "30秒タブレットアンケート",
    feature1Desc:
      "会計待ちにタブレットを渡すだけ。配布・回収・集計の手間をゼロに。患者の負担を最小限に、診療直後のリアルな声を効率的に収集します。",
    feature2Title: "リアルタイムダッシュボード",
    feature2Desc:
      "回答は自動集計され、満足度スコア・回答数・トレンドをリアルタイム表示。手作業なしで、データに基づいた改善判断を実現します。",
    feature3Title: "スタッフの配布習慣化",
    feature3Desc:
      "日次目標・ランクシステム・Kawaii Teethコレクション。ゲーミフィケーションでアンケート配布を日常業務に定着させます。",
    feature4Title: "改善アクション管理",
    feature4Desc:
      "改善施策の登録・効果測定。ベースラインスコアと結果スコアで施策の成果を数値で確認できます。",
    feature5Title: "月次経営レポート",
    feature5Desc:
      "月1回、来院数と売上を入力するだけ。患者単価・自費率・回答率などのKPIを自動算出し、満足度と経営指標の相関をグラフで可視化。手間なく経営改善のPDCAが回せます。",
    ...
    flow3Desc:
      "回答は自動集計され、リアルタイムでダッシュボードに反映。その日から分析を開始できます。",
    ...
    result3Desc: "来院数と売上を入力するだけで、経営指標を自動算出",
    result4Value: "0円",
    ...
    faq6Q: "料金はかかりますか？",
    faq6A:
      "基本機能は永久無料でご利用いただけます。スタンダード（月額19,800円）、エンタープライズ（月額39,800円〜）の有料プランでは、患者属性フィルタ・経営レポート・改善アクション管理などが利用可能です。14日間の無料トライアルもご用意しています。",
    ...
    // Footer
    copyright: "© 2026 株式会社ファンクション・ティ. All rights reserved.",
  ...
  demoSettings: {
    ...
    teethProgressSection: "Kawaii Teeth 進捗",
    teethProgressLabel: "次のKawaii Teethまでの回答数",
    teethProgressHint: "現在のカウンターを直接設定できます（30件ごとに獲得）",
