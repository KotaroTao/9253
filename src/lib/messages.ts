export const messages = {
  ...
  admin: {
    ...
    aiStatus: {
      title: "AI分析ステータス",
      description: "Anthropic API の接続状態を確認・設定",
      statusLabel: "接続状態",
      connected: "正常接続",
      disconnected: "未接続",
      notConfigured: "APIキー未設定",
      model: "使用モデル",
      totalReports: "総分析レポート数",
      latestReport: "最終分析",
      noReports: "レポートなし",
      ...
      apiKeyHint: "ランタイム内で一時的に設定します。永続化にはSecret Managerを使用してください。",
      saveKey: "設定して接続テスト",
      saving: "設定中...",
      keyUpdated: "APIキーを設定し、接続を確認しました",
      invalidKey: "APIキーが無効です。正しいキーを入力してください",
