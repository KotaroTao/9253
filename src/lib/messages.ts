export const messages = {
  ...
  dashboard: {
    ...
    startPatientSurvey: "アンケート（患者端末）",
    startPatientSurveyDesc: "QRコードで患者さまに送信",
    satisfaction: "患者満足度",
    thisMonth: "今月の回答",
  ...
  settings: {
    ...
    postSurveyDesc: "アンケート完了後に患者さまへ表示するリンクを設定します。口コミ・LINE誘導は回答内容に関わらず全員に一律表示されます。",
    postSurveyActionLabel: "完了後の表示",
    postSurveyNone: "アンケートのみで終了",
    postSurveyNoneDesc: "サンクス画面のみ表示",
    postSurveyGoogleReview: "Google口コミに誘導",
    postSurveyGoogleReviewDesc: "Google口コミページへのリンクを表示",
    ...
    complianceNote: "口コミ・LINE誘導は景品表示法および医療広告ガイドラインに準拠しています。回答結果による表示の出し分けは行わず、投稿・友だち追加は患者さまの任意です。",
  },
  testSurvey: {
    title: "アンケートテスト",
    ...
    patientDevice: "アンケート（患者端末）",
    patientDeviceDesc: "QRコード等で患者さまのスマートフォンに表示されるアンケートをテストします。",
    testBadge: "テストモード",
    testNotice: "テストモードの回答は集計に含まれません",
    openInNewTab: "新しいタブで開く",
  },
  postSurvey: {
    googleReviewText: "よろしければGoogleに口コミをお寄せください",
    googleReviewSubText: "皆さまのご意見が、医院の改善に役立ちます",
    googleReviewButton: "Googleで口コミを書く",
    googleReviewNote: "口コミの投稿は任意です",
  ...
  landing: {
    ...
    compliance1Desc:
      "口コミ・LINE誘導はオプション機能として提供。回答結果による表示の出し分けは行わず、医療広告ガイドラインに完全準拠しています。",
