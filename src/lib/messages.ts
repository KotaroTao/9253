export const messages = {
  ...
  onboarding: {
    ...
    step3Title: "経営レポートのPIN設定",
    step3Desc: "経営レポートを閲覧制限するPINを設定しましょう",
    step3PinLabel: "4桁のPIN",
    step3PinPlaceholder: "4桁の数字",
    step3ConfirmLabel: "PIN（確認）",
    step3PinMismatch: "PINが一致しません",
    step3PinInvalid: "4桁の数字を入力してください",
    step3PinSet: "PINを設定しました",
    step3PinNote: "後から設定ページで変更・解除できます",
    step3PinSkipNote: "PINを設定しない場合、経営レポートは誰でも閲覧できます",
    skipStep: "スキップ",
    nextStep: "次へ",
    prevStep: "戻る",
    complete: "セットアップ完了",
  ...
  landing: {
    ...
    solutionDesc:
      "MIERU PXは、タブレットアンケートで患者満足度を定量化し、質問別スコアで改善ポイントを特定。スタッフの配布習慣をゲーミフィケーションで支え、月次レポートで満足度と経営指標の相関を可視化する ── 歯科医院専用の患者満足度向上プラットフォームです。",
    ...
    comparisonTitle: "なぜ MIERU PX なのか",
    ...
    founderBody3:
      "「口コミに頼らない。AIで作らない。」患者さんの本音を可視化し、医院を内側から劇的に変える。歯科医師が、医療従事者の誇りを守るために作ったPX（患者満足度）向上プラットフォーム。それが「MIERU PX」です。",
    founderName: "田尾 耕太郎",
    ...
    faq3A:
      "MIERU PXは口コミ誘導機能を搭載していません。患者への口コミ依頼は行わず、純粋な患者体験改善に特化しています。アンケートで得られた患者の声を改善に活かすことで、口コミ評価も自然に向上するアプローチです。",
    faq4Q: "既存の紙アンケートとの違いは何ですか？",
    faq4A:
      "紙のアンケートは集計に手間がかかり、回答率も低くなりがちです。MIERU PXはタブレットから30秒で回答でき、結果はリアルタイムでダッシュボードに反映。集計作業が不要で、質問別の分析やトレンド把握も自動で行えます。",
    ...
    faq10A:
      "MIERU PXは口コミ誘導機能を搭載していません。患者への口コミ依頼は医療広告ガイドライン上リスクが伴う場合があります。MIERU PXは内部改善に特化し、満足度向上を通じて口コミが自然に改善するアプローチです。",
  ...
  metricsPin: {
    title: "経営レポートのPINロック",
    desc: "4桁のPINを設定すると、経営レポートの閲覧にPIN入力が必要になります",
    pinLabel: "4桁のPIN",
    pinPlaceholder: "4桁の数字",
    currentPinLabel: "現在のPIN",
    newPinLabel: "新しいPIN",
    confirmPinLabel: "新しいPIN（確認）",
    setPinButton: "PINを設定する",
    changePinButton: "PINを変更する",
    removePinButton: "PINを解除する",
    pinSet: "PINを設定しました",
    pinChanged: "PINを変更しました",
    pinRemoved: "PINを解除しました",
    pinMismatch: "PINが一致しません",
    pinInvalid: "4桁の数字を入力してください",
    currentPinWrong: "現在のPINが正しくありません",
    lockTitle: "経営レポート",
    lockDesc: "閲覧するにはPINを入力してください",
    unlockButton: "解除",
    wrongPin: "PINが正しくありません",
    status: "PIN設定済み",
    statusNone: "PIN未設定",
    resetPin: "PINリセット",
    resetPinConfirm: "このクリニックの経営レポートPINをリセットしますか？",
    resetPinSuccess: "PINをリセットしました",
  },
} as const
