export const messages = {
  ...
  dashboard: {
    ...
    adminModeDesc: "満足度分析・スタッフ管理・設定を表示中",
  ...
  adminMode: {
    unlock: "管理者ログイン",
    unlockDesc: "満足度分析・設定を表示するにはパスワードを入力してください",
    lock: "管理者モードを終了",
    password: "管理者パスワード",
    unlockButton: "ログイン",
  ...
  settings: {
    ...
    adminPasswordDesc: "ダッシュボードの「管理者ログイン」で使用するパスワードです。分析レポート・スタッフ管理・設定画面へのアクセスを制限します。",
