...
export const authConfig = {
  ...
  callbacks: {
    ...
    async authorized({ auth, request: { nextUrl } }) {
      ...
      const publicRoutes = ["/login", "/register", "/verify-email", "/forgot-password", "/reset-password", "/kiosk/", "/t/", "/investor", "/strategy", "/research-protocol", "/guide", "/getting-started", "/git-basics"]
