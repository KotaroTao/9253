...
const products = [
  {
    ...
    description:
      "2つのコースで歯科スタッフのAI活用を支援。「Claude Code導入コース」では完全初心者が開発に必要な基礎知識を習得し、Claude Codeでの開発環境を確実に構築。「開発実践コース」では中上級者が業務改善アプリを実際に開発。卒業生は専用コミュニティに参加し、開発相談や他の卒業生が作ったアプリの紹介などが定期的に配信される。講師の田尾耕太郎は、1日5万人以上が訪れる歯科サイトの相談掲示板システムや、カルテ数15,000超のアライナー矯正専用WEB管理システムなどを構築した実績を持つ。現在はClaude Codeをフル活用し、開発期間・コストを従来の約1/10に短縮。本プログラムでは田尾が実際に使っている開発環境を、プログラミング初心者でも使いやすいように改良して提供する。",
    pricing: [
    ...
    highlights: [
      "講師は歯科サイト（日間5万PV）や矯正管理システム（15,000カルテ超）を構築した現役開発者",
      "Claude Code活用で開発期間・コストを従来の約1/10に短縮",
      "人材開発支援助成金で最大75%補助",
      "卒業生専用コミュニティで継続サポート",
    ],
