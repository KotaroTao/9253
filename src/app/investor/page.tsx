...
const products = [
  {
    ...
    description:
      "2つのコースで歯科スタッフのAI活用を支援。「Claude Code導入コース」では完全初心者が開発に必要な基礎知識を習得し、Claude Codeでの開発環境を確実に構築。「開発実践コース」では中上級者が業務改善アプリを実際に開発。卒業生は専用コミュニティに参加し、開発相談や他の卒業生が作ったアプリの紹介などが定期的に配信される。",
    pricing: [
